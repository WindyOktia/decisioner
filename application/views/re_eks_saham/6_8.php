        ...
        <div class="row">
            ...
            <legend class="text-center border-bottom border-info"><b>Rasio KPMM</b></legend>
                ...
                <div class="text-center mt-3">
                    <button id="11" class="btn btn-success btn-block stay" onclick="submission( <?php echo $this->session->userdata('id_user');?>,3,3,4,1)" disabled>Menjual Saham</button>
                    <button id="12" class="btn btn-danger btn-block stay" onclick="submission( <?php echo $this->session->userdata('id_user');?>,3,3,4,0)" disabled>Tidak Menjual Saham</button>
                </div>
                <br>
            </div>
        </div>
