            ...
            <tbody>
                <tr>
                    ...
                    <th class="text-center">
                        <button class="btn btn-success btn-sm btn-block j1 mb-2" onclick="submission( <?php echo $this->session->userdata('id_user');?>,2,2,6,1)">Jual Saham</button>
                        <button class="btn btn-danger btn-sm btn-block t1" onclick="submission( <?php echo $this->session->userdata('id_user');?>,2,2,6,0)">Tahan Saham</button>
                    </th>
                </tr>
                <tr id="ops2" style="display:none;background-color:#EAEBED">
                    ...
                    <th >
                        <button class="btn btn-success btn-sm btn-block j2" onclick="submission( <?php echo $this->session->userdata('id_user');?>,2,2,15,1)">Jual Saham</button>
                        <button class="btn btn-danger btn-sm btn-block t2" onclick="submission( <?php echo $this->session->userdata('id_user');?>,2,2,15,0)">Tahan Saham</button>
                    </th>
                </tr>
                <tr id="ops3" style="display:none">
                    ...
                    <th>
                        <button class="btn btn-success btn-sm btn-block j3" onclick="submission( <?php echo $this->session->userdata('id_user');?>,2,2,25,1)">Jual Saham</button>
                        <button class="btn btn-danger btn-sm btn-block t3" onclick="submission( <?php echo $this->session->userdata('id_user');?>,2,2,25,0)">Tahan Saham</button>
                    </th>
                </tr>
            </tbody>
        </table>
