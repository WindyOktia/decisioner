    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-md" style="font-size:14px">
                ...
                <span><a href="<?= base_url('responden/d8')?>" class="btn btn-sm btn-info float-right next_ref_3" style="display: none;">Lanjut <i class="ml-1 fa fa-arrow-circle-right"></i></a></span>
                </h1>
                <legend>Keputusan Anda <span id="jawab_ref_3">Belum Menjawab</span></legend>
                <button class="btn btn-success btn-block tarik_ref_4 show_opsi_4" onclick="submission( <?php echo $this->session->userdata('id_user');?>,4,1,6,1)" disabled>Menjual Saham</button>
                <button class="btn btn-danger btn-block t-tarik_ref_4 show_opsi_4" onclick="submission( <?php echo $this->session->userdata('id_user');?>,4,1,6,0)" disabled>Tidak Menjual Saham</button>
            </div>
        </div>
    </div>
</div>
