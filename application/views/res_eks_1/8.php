            ...
            <tbody>
                <tr>
                    ...
                    <th>
                        <div class="row">
                            <div class="col-md">
                                <button class="btn btn-success btn-block tt_1_1" onclick="submission( <?php echo $this->session->userdata('id_user');?>,1,3,4,1)">Tarik Tabungan</button>
                            </div>
                            <div class="col-md">
                                <button class="btn btn-danger btn-block tmt_1_1" onclick="submission( <?php echo $this->session->userdata('id_user');?>,1,3,4,0)">Tidak Menarik Tabungan</button>
                            </div>
                        </div>
                    </th>
                </tr>
