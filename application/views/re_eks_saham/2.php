...
<div class="card mt-2" id="eks_1">
    <div class="card-body">
            ...
            <tbody>
                <tr>
                    ...
                    <th style="width:30%">
                        <div class="row">
                            <div class="col-md">
                                <button class="btn btn-success btn-sm j1" onclick="submission( <?php echo $this->session->userdata('id_user');?>,1,2,6,1)">Jual Saham</button>
                            </div>
                            <div class="col-md">
                                <button class="btn btn-danger btn-sm t1" onclick="submission( <?php echo $this->session->userdata('id_user');?>,1,2,6,0)">Tahan Saham</button>
                            </div>
                        </div>
                    </th>
                </tr>
                <tr id="ops2" style="display:none">
                    ...
                    <th style="width:30%">
                        <div class="row">
                            <div class="col-md">
                                <button class="btn btn-success btn-sm j2"  onclick="submission( <?php echo $this->session->userdata('id_user');?>,1,2,15,1)">Jual Saham</button>
                            </div>
                            <div class="col-md">
                                <button class="btn btn-danger btn-sm t2"  onclick="submission( <?php echo $this->session->userdata('id_user');?>,1,2,15,0)">Tahan Saham</button>
                            </div>
                        </div>
                    </th>
                </tr>
                <tr id="ops3" style="display:none">
                    ...
                    <th style="width:30%">
                        <div class="row">
                            <div class="col-md">
                                <button class="btn btn-success btn-sm j3"  onclick="submission( <?php echo $this->session->userdata('id_user');?>,1,2,25,1)">Jual Saham</button>
                            </div>
                            <div class="col-md">
                                <button class="btn btn-danger btn-sm t3"  onclick="submission( <?php echo $this->session->userdata('id_user');?>,1,2,25,0)">Tahan Saham</button>
                            </div>
                        </div>
                    </th>
                </tr>
        ...
        <a href="<?= base_url('responden/d3')?>" type="button" onclick="return confirm('Yakin? Jawaban tidak dapat diubah setelah dikirim!');" class="btn btn-primary float-right mt-3 submit" style="display:none"><i class="fa fa-location-arrow mr-2"></i> Kirim Jawaban</a>
    </div>
