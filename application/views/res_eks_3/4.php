            ...
            <legend class="text-center border-bottom border-info"><b>Suku Bunga LPS</b></legend>
                ...
                <h1 class="text-center" style="font-size:42px"><b>6</b> % 
                    <span class="float-right">
                        <a href="<?= base_url('responden/c5')?>" class="btn btn-primary nexts" style="display:none">Next <i class="fa fa-arrow-circle-right ml-2"></i></a>
                    </span>
                </h1>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <h4>Pengujian Selanjutnya adalah menggunakan indeks Suku Bunga LPS</h4>
      <h4>Semakin besar Suku Bunga LPS, maka Simpanan anda semakin aman</h4>
      </div>
