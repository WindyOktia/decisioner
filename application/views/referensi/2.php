...
<div class="card mt-2" id="eks_1">
    <div class="card-body">
        ...
        <a href="<?= base_url('responden/ref3')?>" type="button" onclick="return confirm('Yakin? Jawaban tidak dapat diubah setelah dikirim!');" class="btn btn-primary float-right mt-3 submit" style="display:none"><i class="fa fa-location-arrow mr-2"></i> Kirim Jawaban</a>
    </div>
