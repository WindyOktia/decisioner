            ...
            <legend class="text-center border-bottom border-info"><b>Suku Bunga Simpanan</b></legend>
                ...
                <h1 class="text-center" style="font-size:42px"><b>16</b> % 
                    <span class="float-right">
                        <a href="<?= base_url('responden/d6_3')?>" class="btn btn-primary nexts" style="display:none">Next <i class="fa fa-arrow-circle-right ml-2"></i></a>
                    </span>
                </h1>
                ...
                <div class="text-center mt-3">
                    <button id="11" class="btn btn-success btn-block stay" onclick="submission( <?php echo $this->session->userdata('id_user');?>,3,1,16,1)" disabled>Menjual Saham</button>
                    <button id="12" class="btn btn-danger btn-block stay" onclick="submission( <?php echo $this->session->userdata('id_user');?>,3,1,16,0)" disabled>Tidak Menjual Saham</button>
                </div>
                <br>
            </div>
        </div>
