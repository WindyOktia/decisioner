        ...
        <div class="row">
            ...
            <legend class="text-center border-bottom border-info"><b>Suku Bunga Simpanan</b></legend>
                ...
                <div class="text-center mt-3">
                    <button id="11" class="btn btn-success btn-block  stay" onclick="submission( <?php echo $this->session->userdata('id_user');?>,2,1,6,1)" disabled>Tarik Tabungan</button>
                    <button id="12" class="btn btn-danger btn-block stay" onclick="submission( <?php echo $this->session->userdata('id_user');?>,2,1,6,0)" disabled>Tidak Menarik Tabungan</button>
                </div>
                <br>
            </div>
        </div>
