    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-md" style="font-size:14px">
                ...
                <h1 style="font-size:42px" class="text-warning text-center"><b>4 %</b>
                ...
                <button class="btn btn-success btn-block tarik_ref_4 show_opsi_4" onclick="submission( <?php echo $this->session->userdata('id_user');?>,4,3,4,1)" disabled>Menjual Saham</button>
                        <button class="btn btn-danger btn-block t-tarik_ref_4 show_opsi_4" onclick="submission( <?php echo $this->session->userdata('id_user');?>,4,3,4,0)" disabled>Tidak Menjual Saham</button>
            </div>
        </div>
    </div>
</div>
