            ...
            <div class="col-md">
                ...
                <div class="row">
                    ...
                    <div class="col mx-auto my-auto">
                        <h1 style="font-size:42px" class="text-warning"><b>8 %</b></h1>
                    </div>
                </div>
            </div>
            <div class="col-md ">   
                <legend>Keputusan Anda : <span id="jawab_ref_3">Belum Memilih</span><span><a href="<?= base_url('responden/d14')?>" class="float-right next_ref_3" style="display: none;">Lanjut <i class="ml-1 fa fa-arrow-circle-right"></i></a></span></legend>
                <div class="col-12">
