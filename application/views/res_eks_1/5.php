...
<div class="card mt-2" id="eks_1">
    <div class="card-body">
            ...
            <tbody>
                <tr>
                    ...
                    <th>
                        <div class="row">
                            <div class="col-md">
                                <button class="btn btn-success btn-block tt_1_1" onclick="submission( <?php echo $this->session->userdata('id_user');?>,1,2,15,1)">Tarik Tabungan</button>
                            </div>
                            <div class="col-md">
                                <button class="btn btn-danger btn-block tmt_1_1" onclick="submission( <?php echo $this->session->userdata('id_user');?>,1,2,15,0)">Tidak Menarik Tabungan</button>
                            </div>
                        </div>
                    </th>
                </tr>
        ...
        <a href="<?= base_url('responden/a16')?>" onclick="return confirm('Yakin? Jawaban tidak dapat diubah setelah dikirim!');" class="btn btn-primary float-right mt-3 submit" style="display:none"><i class="fa fa-location-arrow mr-2"></i> Kirim Jawaban</a>
    </div>
</div>
